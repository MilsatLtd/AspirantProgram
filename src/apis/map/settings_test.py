...
CORS_ALLOWED_ORIGINS = [
    ...
    "https://test-admin-asp.milsat.africa",
    "https://test-aspirant.milsat.africa",
    "https://test-aspirant-api.milsat.africa",
    "http://localhost:5173",
...
ASGI_APPLICATION = 'map.asgi.application'
...
AUTHENTICATION_BACKENDS = [
    "api.backends.AuthBackend.AuthModelBackend",
...
SIMPLE_JWT = {
    ...
    "TOKEN_OBTAIN_SERIALIZER": "api.views.AuthViews.MyTokenObtainPairSerializer",
...
if DEBUG:
    SWAGGER_SETTINGS['url'] = 'http://localhost:8000'

# LOG TO SLACK, CONSOLE AND FILE
LOGGING = {
    'version': 1,
