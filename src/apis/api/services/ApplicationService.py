...
class ReviewApplication:
    ...
    def create_mentor(self, application):
        ...
        new_mentor.save()
        logger.info(f"Added a new mentor to the track: {track.id} with email: {user.email} and password: {password}")
    ...
    def create_student(self, application):
        ...
        new_student.save()
        logger.info(f"Added a new student to the track: {track.id} with email: {user.email} and password: {user.password}")
