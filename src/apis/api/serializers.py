...
class CreateApplicationSerializer(serializers.Serializer):
    ...
    referral_source = serializers.CharField(max_length=200, required=False, allow_null=True)
    phone_number = serializers.CharField(max_length=11)
    reason = serializers.CharField(max_length=3500)
    referral = serializers.CharField(max_length=3500)
    skills = serializers.CharField(max_length=3500)
    purpose = serializers.CharField(max_length=3500)
