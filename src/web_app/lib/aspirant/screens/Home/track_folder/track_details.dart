...
class TrackDetails extends ConsumerStatefulWidget {
  static const String name = 'track-details';
  static const String route = '/track-details';
                            ...
                            children: [
                              ...
                              Expanded(
                                child: RefreshIndicator(
                                  onRefresh: () =>
                                      ref.refresh(coursesDetails.future),
                                  child: ListView.separated(
                                    itemBuilder:
                                        (BuildContext context, int index) {
                                      bool canView = data.courses!
                                          .elementAt(index)
                                          .canView!;
