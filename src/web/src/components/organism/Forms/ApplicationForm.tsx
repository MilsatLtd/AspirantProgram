...
const ApplicationForm = (props: applicationFormType) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`flex ${
          changeSection === "sectionB" ? "justify-between" : "justify-end"
        } mt-16`}
      >
        {changeSection === "sectionB" && (
          <div
            className="flex flex-row gap-12 items-center cursor-pointer"
            onClick={() => {
              setChangeSection("sectionA");
              setPercent(50);
            }}
          >
      ...
      <section className="mt-[39.44px] transition delay-150 ease-in-out">
        ...
        <div
          className={` ${changeSection === "sectionA" ? "block" : "hidden"}`}
        >
          <FormSectionA
