...
const TrackCards = () => {
  ...
  return (
    <section className="lg:px-96 md:px-48 px-0 text-center flex flex-col justify-center lg:items-center md:items-center lg:gap-50 gap-24 mt-58 mb-[122.9px] z-20 relative ">
      <div className="text-center items-center justify-center gap-12 lg:p-0 md:p-0 px-52 flex flex-col">
        ...
        <p className="lg:text-lg lg:w-[600px] text-m-base font-medium lg:leading-[36px] leading-[28px] text-N200 text-center ">
          Navigate your GIS learning journey with our expertly curated courses
          to make informed career choices.
        </p>
      </div>

      <div className=" overflow-auto overscroll-contain scrollbar-hide cursor-grab lg:overflow-visible md:w-full md:h-full lg:w-full lg:h-full py-16 px-16">
